...
Se sono uguali la pallina tende a muoversi in diagonale. Se la vel_x è molto più grande, tende a muoversi in orizzontale. 
Se vel_y è molto più grande, tende a muoversi in verticale.
...
Devo includere BALL_RADIUS nei controlli di collisione della pallina con i bordi.
...
Perchè la gravità aumenta la velocità verso il basso ad ogni frame, quindi la pallina raggiunge un’altezza minore.